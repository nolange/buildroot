...
ifneq ($(TARGET_BUTILS_PRE),)
HOST_GCC_COMMON_CONF_ENV += AR_FOR_TARGET=$(TARGET_BUTILS_PRE)ar NM_FOR_TARGET=$(TARGET_BUTILS_PRE)nm RANLIB_FOR_TARGET=$(TARGET_BUTILS_PRE)ranlib
endif
